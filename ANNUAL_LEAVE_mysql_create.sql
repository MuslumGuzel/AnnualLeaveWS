...
ALTER DATABASE ANNUAL_LEAVE_APP CHARACTER SET utf8 COLLATE utf8_general_ci;
...
alter table `ANNUAL_LEAVE_APP`.`PERSONNEL` convert to character set utf8 collate utf8_general_ci;
alter table `ANNUAL_LEAVE_APP`.`LEAVES` convert to character set utf8 collate utf8_general_ci;
alter table `ANNUAL_LEAVE_APP`.`LEAVE_TYPES` convert to character set utf8 collate utf8_general_ci;
